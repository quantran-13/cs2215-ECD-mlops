...
from src.training_pipeline.src import transformers
...
def build_baseline_model(seasonal_periodicity: int):
    """Build a naive forecaster baseline model using Sktime that predicts the last value given a seasonal \
        periodicity."""
